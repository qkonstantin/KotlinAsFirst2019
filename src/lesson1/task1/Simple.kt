 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = deg*PI/180+min*PI/(60*180)+sec*PI/(180*3600)
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = ((initial*percent/100.0+initial)*percent/100.0+(initial*percent/100.0+initial))*percent/100.0+((initial*percent/100.0+initial)*percent/100.0+(initial*percent/100.0+initial))
